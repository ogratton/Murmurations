...
class SP:
    ...
    REPULSION_POINT = (
        0.2  # value in the 5th dimension under which attractors become repulsors
    )
    COHESION_NEIGHBOURHOOD = (
        0.5  # NEIGHBOURHOOD is ratio of edge_length (so 0.5 is from half the cube away)
    )
