...
def main():
    ...
    swarm_data = [
                    (Swarm.Swarm(10, cube, 6), 0, inst.YAMAHA_GRAND_PIANO),
                    (Swarm.Swarm(10, cube, 3), 1, inst.NYLON_STRING_GUITAR),
                    (Swarm.Swarm(10, cube, 1), 2, inst.PIZZICATO_SECTION),
                    (Swarm.Swarm(10, cube, 6), 9, inst.AGOGO),
                    (Swarm.Swarm(10, cube, 2), 3, inst.BANJO)    
    ]
