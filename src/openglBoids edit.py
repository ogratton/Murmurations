...
# TODO remove 'hypertorus' and make it a normal cube
...
class Boid(object):
    ...
    def __init__(self):
        ...
        # TODO start at random locations
    ...
    def wrap(self, cube0, cube1):
        # TODO
        """
        // constrain boid to graph
        turning = Vector3.Distance(transform.position, Vector3.zero) >= globalFlock.graphSize;
...
class Flock(object):
    ...
    def update(self):
        ...
        for boid in self.boids:  # TODO is this line necessary?
